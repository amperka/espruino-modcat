...
var GasSensor = function(opts) {
  ...
  if (Sensors[opts.model] === undefined) {
    return new Error('Error in model name. Use MQ2, MQ3, MQ4, MQ5, MQ6, MQ7, MQ8, MQ9');
  }
...
GasSensor.prototype.read = function(gas) {
  ...
  var res = Math.pow(Math.E, (Math.log(ratio) - this._model.gas[gas].coef[1]) / this._model.gas[gas].coef[0]);
